...
**Frontend:** Streamlit interface with three pages: Menu Management, Dashboard, and Sales Forecasting.
**Backend:** 
...
Cleans data: removes duplicates, outliers (1st/99th percentiles), future dates, and invalid entries.
